...
<body class="font-sans min-h-screen bg-gradient-main flex items-center justify-center py-5 overflow-auto">
    <div class="flex w-[900px] min-h-[700px] rounded-3xl overflow-hidden shadow-2xl max-md:flex-col max-md:w-[95%] max-md:h-auto max-md:max-w-sm">
        <!-- Welcome Section -->
        <div class="flex-1 bg-gradient-welcome flex flex-col justify-center items-center text-center text-white relative overflow-hidden min-h-[700px] max-md:p-10 max-md:min-h-[200px]">
            <!-- Decorative circles -->
        ...
        <div class="flex-1 bg-white px-12 py-10 flex flex-col justify-center overflow-y-auto max-md:px-8">
            ...
            <form action="<?= base_url('auth/attempt-register') ?>" method="post">
                ...
                <div class="mb-5">
                    <label class="block text-sm text-gray-600 mb-2 font-medium" for="full_name">Full Name</label>
                    <input type="text" 
                           id="full_name" 
                           name="full_name" 
                ...
                <div class="mb-5">
                    <label class="block text-sm text-gray-600 mb-2 font-medium" for="username">Username</label>
                    <input type="text" 
                           id="username" 
                           name="username" 
                           class="w-full px-5 py-3 border-2 border-gray-200 rounded-xl text-sm transition-all duration-300 bg-gray-50 
                ...
                <div class="mb-6">
                    <label class="block text-sm text-gray-600 mb-2 font-medium" for="confirm_password">Confirm Password</label>
                    <input type="password" 
                           id="confirm_password" 
            ...
            <div class="text-center text-sm text-gray-600">
                ...
                <a href="<?= base_url('auth/login') ?>" class="text-purple-start font-semibold hover:underline">Sign In</a>
            </div>
        </div>
    </div>
</body>
